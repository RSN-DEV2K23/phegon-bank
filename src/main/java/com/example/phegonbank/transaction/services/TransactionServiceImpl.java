...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public Response<?> createTransaction(TransacctionRequest transacctionRequest) {
    ...
    public Response<List<TransactionDTO>> getTransactionForMyAccount(String accountNumber, int page, int size) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getTransactionForMyAccount'");
    }
}
